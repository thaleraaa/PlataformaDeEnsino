...
async function administradoresRoutes(fastify: FastifyInstance) {
    ...
    fastify.get('/:administrador_id', { ...getAdministradorByIdSchema, preHandler: [authMiddleware, isAdministrador] }, administradorController.getParamId);
    fastify.get('/me', {...getAdministradorDetail ,preHandler: [authMiddleware, isAdministrador]}, administradorController.getDetail);
    fastify.delete('/:administrador_id', { ...deleteAdministradorSchema, preHandler: [authMiddleware, isAdministrador] }, administradorController.delete);
