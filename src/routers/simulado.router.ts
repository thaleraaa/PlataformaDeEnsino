...
import { createSimuladoSchema, deleteSimuladoSchema, getExerciciosBySimuladoSchema, getSimuladoByIdSchema, getSimuladoSchema, updateSimuladoSchema } from "../schemas/simulado.schema";
