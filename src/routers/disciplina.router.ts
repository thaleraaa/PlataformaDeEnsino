...
import { deleteDisciplinaSchema, getDisciplinaByIdSchema, getDisciplinaSchema, getModulosByDisciplinaIdSchema, postDisciplinaSchema, putDisciplinaSchema } from '../schemas/disciplina.schema.js';
...
async function disciplinasRoutes(fastify: FastifyInstance) {
    ...
    fastify.get('/:id/modulos', {...getModulosByDisciplinaIdSchema, preHandler: [authMiddleware]}, disciplinaController.getModulos);
